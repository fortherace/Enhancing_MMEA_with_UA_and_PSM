...
ins_list = ['mmf1', 'mmf1', 'mmf2', 'mmf3', 'mmf4', 'mmf5', 'mmf6', 'mmf7', 'mmf8', 'mmf9', 'mmf1_e', 'mmf1_z', 'mmf14', 'mmf14_a', 'omnitest', 'sympart']
...
matlab_dir = r'D:\Project\PyCharm_Code\Enhancing_MMEA_with_UA_and_PSM\MMEAs\MMEAPSL'
...
for test_ins in ins_list:
    ...
    for run_iter in range(n_run):
        ...
        # ------------------------------------------ Evolutionary Search ---------------------------------------------------
        func_name = f"run_mmeapsl_{test_ins}"
        ...
        # save_dir = os.path.join("Graph", "MMEAPSL(our)", test_ins.upper())
