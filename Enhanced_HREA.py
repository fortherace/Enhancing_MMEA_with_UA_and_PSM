...
matlab_dir = r'D:\Project\PyCharm_Code\\Enhancing_MMEA_with_UA_and_PSM\MMEAs\HREA'
...
for test_ins in ins_list:
    ...
    for run_iter in range(n_run):
        ...
        # ------------------------------------------ Evolutionary Search ---------------------------------------------------
        func_name = f"run_hrea_{test_ins}"
        ...
        # save_dir = os.path.join("Graph", "HREA(our)", test_ins.upper())
